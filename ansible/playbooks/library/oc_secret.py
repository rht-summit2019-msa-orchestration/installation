...
class OCSecret(OpenShiftCLI):
    ...
    def create(self, files=None, contents=None, from_literal=None, force=False):
        '''Create a secret '''
        cmd = ['create', 'secret']
    ...
    def run_ansible(params, check_mode):
        ...
        if state == 'present':
            ...
            if not Utils.exists(api_rval['results'], params['name']):
                ...
                api_rval = ocsecret.create(files, params['contents'], params['from_literal'], force=params['force'])
